			...
			<div class="col-4">
				<form action="">
					<div class="form-group">
						<label for="rechercheArticle">Filtres : </label> <input
							type="text" id="rechercheArticle" name="rechercheArticle">
					</div>
					...
					<c:if test="${!empty sessionScope}">
						<div class="form-group">
							<ul>
								<li><input type="radio" id="achat" name="achatetvente"><label
									for="achat"> Achats</label>
									<ul>
										<li><label><input type="checkbox"
												class="checkAchat"> Enchéres ouvertes</label></li>
										<li><label><input type="checkbox"
												class="checkAchat"> Mes enchéres</label></li>
										<li><label><input type="checkbox"
												class="checkAchat"> Mes enchéres remportées</label></li>
									</ul> <input type="radio" id="vente" name="achatetvente"><label
									for="vente"> Mes ventes</label>
									<ul>
										<li><label><input type="checkbox"
												class="checkVente"> Mes ventes en cours</label></li>
										<li><label><input type="checkbox"
												class="checkVente"> Ventes non débutées</label></li>
										<li><label><input type="checkbox"
												class="checkVente"> Ventes terminées</label></li>
									</ul></li>
							</ul>
						</div>
