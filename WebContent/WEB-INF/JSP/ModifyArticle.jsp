		...
		<form action="<c:url value = "/ModifyArticle"/>" method="post">
			<div class="mb-3 form-group">
				...
				<input type="text" class="form-control" id="nameArticle"
					name="nameArticle" value="${requestScope.article.nameArticle }">
			...
			<div class="mb-3 form-group">
				...
				<textarea class="form-control" id="description" rows="3"
					name="description" value="${requestScope.article.description }"></textarea>
			...
			<div class="input-group mb-3 form-group">
				<input type="text" class="form-control"
					...
					name="${requestScope.article.priceStart }"> <span
					class="input-group-text" id="points">points</span>
			</div>
			<div class="mb-3 form-group">
				<label for="StartAuction" class="form-label">Début de
					...
					value="${requestScope.article.dateStartAuction}">
			...
			<div class="mb-3 form-group">
				...
				<input type="datetime-local" class="form-control" id="EndAuction"
					name="EndAuction"
					value="${!empty requestScope.article.dateEndAuction ? requestScope.article.dateEndAuction : '' }">
